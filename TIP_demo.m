...
ceilPane = imtransform(im, ceilTran, 'XData', [destCeiling(1,1), destCeiling(1,2)], 'YData', [destCeiling(2,1)-200, destCeiling(2,3)-200]);
...
tempCeil = imtransform(ceilIm, maketform('projective', eye(3)), 'XData', [1000, 2000], 'YData', [2000, 3000]);
